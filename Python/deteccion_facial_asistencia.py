...
encodings = find_encodings(images)  # Listado de encodings

# Convertir los encodings (numpy arrays) a listas y guardarlos en un archivo JSON
encodings_dict = {classNames[i]: encodings[i].tolist() for i in range(len(encodings))}
